			...
			try {
				if (lastID != null) {
					...
					for (int i = 0; i < corpus.size(); i++) {
						...
						if (!myEmail.equals("myemailaddress")) {
							try {
							...
							System.out.println("Lab report is from me and was not saved in database.");
						...
						if (!myEmail.equals("myemailaddress")) {
							...
							System.out.println("Lab report is from me and was not saved to Mimir.");
						}
