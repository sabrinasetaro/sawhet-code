...
public class FeedbackText {
	...
	private static String _wrongCitIntro = "SAWHET detected some issues with your citation format. The correct citation format is: [FirstAuthor: Year]. If you are citing more than two papers it would be: [FirstAuthor: Year][FirstAuthor: Year]. Please revise accordingly.";
