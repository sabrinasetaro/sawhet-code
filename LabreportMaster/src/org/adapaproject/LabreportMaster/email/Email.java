...
public class Email {
	...
	public void generateEmail() throws AddressException, MessagingException, IOException {        
		...
		try {
			...
			String message = "Your lab report is attached.\n\nPlease go through the document and make sure the pictures are not too small or too big. Also, check out the suggestion part to see how you can improve your submission. In case you want to resubmit, just start a new submission in SAWHET.\n\nRegards,\nLab Report Submission System\n\nFor Questions, please contact Sabrina Setaro, setarosd@wfu.edu";
